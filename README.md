...
- **文本语音** — 支持配置复杂的文本和语音，支持多语言
  - <img src="docs/imgs/state1.png"/>

- **对话事件链** — 支持文本事件链，包括直接链接，对话分支，随机触发等
  - <img src="docs/imgs/state2.png"/>

- **条件触发** — 按日期/时间/计数器/气温/天气/运行时长等条件限制触发
  - <img src="docs/imgs/state3.png"/>
...
<img src="docs/imgs/editor1.png"/>
<img src="docs/imgs/editor2.png"/>
<img src="docs/imgs/editor3.png"/>
<img src="docs/imgs/editor4.png"/>
<img src="docs/imgs/state1.png"/>
