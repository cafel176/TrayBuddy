...
<p align="center">
  本项目所有功能均支持 i18n 多语言。
  <br>
  All features of this project support i18n localization.
  <br>
  本プロジェクトの全機能は i18n による多言語対応です。
</p>
...
**TrayBuddy** 是一款支持 **多种动画类型、包加密、高度自定义** 的桌宠应用，致力于让用户 **用任何动画格式快速制作桌宠**
...
<a href="https://pan.baidu.com/s/5674aiDV7d4JWbMEySD28Ew" target="_blank" rel="noopener noreferrer">百度网盘</a>&nbsp;&nbsp;&nbsp;
...
演示素材作者：
<a href="https://b23.tv/W95QcGZ" target="_blank" rel="noopener noreferrer">露姆娅</a>&nbsp;&nbsp;&nbsp;
...
用任何动画资源快速开始：
<a href="docs/tutorial/NewMod.md" target="_blank" rel="noopener noreferrer">快速 迁移/制作 桌宠</a>
...
如果内容出现 许可/版权 问题，请联系我们更换或删除

后续会增加更多的样例

<br>

<a href="" target="_blank" rel="noopener noreferrer"><b>序列帧 半身</b></a>
...
<a href="" target="_blank" rel="noopener noreferrer"><b>序列帧 全身</b></a>

https://github.com/user-attachments/assets/209e9368-a991-46c4-b602-bebdad07f821

<br>

<a href="" target="_blank" rel="noopener noreferrer"><b>序列帧 物体</b></a>

**请打开声音播放**

https://github.com/user-attachments/assets/7309ee75-d941-432f-8123-ba25004da64b
...
<a href="https://www.bilibili.com/video/BV1pbxnz5EvD/?share_source=copy_web&vd_source=83959be6660f3ec16d301ccce33457e7" target="_blank" rel="noopener noreferrer"><b>PngRemix (@dazeroyuu)</b></a>
...
<a href="https://booth.pm/en/items/3226395" target="_blank" rel="noopener noreferrer"><b>3D 模型 VRM</b></a>
...
8. AI小工具：<a href="#zh-AI小工具">**AI小工具，提供忙碌时陪伴**</a>

9. 辅助功能：<a href="#zh-辅助功能">**备忘录和定时提醒**</a>

10. 多语言：<a href="#zh-多语言">**简体中文/English/日本語**</a>
...
<img src="docs/imgs/profile1.png"/>
...
<img src="docs/imgs/zh/profile2.png" width="540"/>
<img src="docs/imgs/profile3.png"/>

<br>

同时，我们支持通过自定义配置调整最大帧率<br>
过高的帧率会导致GPU占用增加，适当降低帧率可以减少GPU占用<br>
应用安装后，您可修改安装目录内 **Config** 文件夹下的 **render_tuning.json** 文件来自定义优化行为
...
- **文本语音** — 支持配置复杂的文本和语音，支持多语言
  - <img src="docs/imgs/zh/state1.png"/>

- **对话事件链** — 支持文本事件链，包括直接链接，对话分支，随机触发等
  - <img src="docs/imgs/zh/state2.png"/>

- **条件触发** — 按日期/时间/计数器/气温/天气/运行时长等条件限制触发
  - <img src="docs/imgs/zh/state3.png"/>
...
<img src="docs/imgs/zh/editor1.png"/>
<img src="docs/imgs/zh/editor2.png"/>
<img src="docs/imgs/zh/editor3.png"/>
<img src="docs/imgs/zh/editor4.png"/>
<img src="docs/imgs/zh/state1.png"/>
...
<img src="docs/imgs/zh/mod1.png" width="540"/>
<img src="docs/imgs/zh/mod2.png" width="540"/>
...
本程序提供自定义AI小工具，可以检测您当前使用的软件或游戏，并对支持的软件或游戏提供反馈

主要效果取决于您的提示词和AI的智力

<br>

<a href="https://www.bilibili.com/video/BV1idwczDE41" target="_blank" rel="noopener noreferrer"><b>演示视频</b></a>

<a href="https://www.bilibili.com/video/BV1idwczDE41" target="_blank" rel="noopener noreferrer"><img src="docs/imgs/微信图片_20260311162306_1619_13.png" width="540"/></a>
...
- **备忘录** — 每次解锁屏幕时自动弹出，也可手动查看
  - <img src="docs/imgs/zh/other1.png" width="540"/>
- **定时提醒** — 设置指定时间的弹窗提醒
  - <img src="docs/imgs/zh/other2.png" width="540"/>
...
本项目支持i18n实时多语言切换，您可以在 **右键菜单-设置-界面语言** 内进行调整

<img src="docs/imgs/lang1.png" width="180"/>
<img src="docs/imgs/lang2.png" width="540"/>
...
应用安装后，用户可修改安装目录内Config文件夹下的配置文件来自定义行为：
...
| `config/render_tuning.json` | 优化相关配置，帧率限制 |
...
<a href="https://pan.baidu.com/s/5674aiDV7d4JWbMEySD28Ew" target="_blank" rel="noopener noreferrer">Baidu Netdisk</a>&nbsp;&nbsp;&nbsp;
...
Quick start with any animation asset:
<a href="docs/tutorial/NewMod.md" target="_blank" rel="noopener noreferrer">Quickly migrate/create desktop pets</a>
...
The displayed Mods are for demonstration purposes only; please see the corresponding links for sources

If the content has any licensing/copyright issues, please contact us to replace or remove it
...
<a href="" target="_blank" rel="noopener noreferrer"><b>Sprite Sheet Object</b></a>
...
3. Memory optimization: <a href="#en-memory-optimization">**texture downsampling, frame rate limiting, etc.**</a>

4. Supports complex <a href="#en-dialogue-event-chains">**dialogue event chains**</a> and voice configuration

5. Supports various events: <a href="#en-system-events">**keyboard/mouse, music playback, computer unlock, work app launch, drag, fullscreen app launch, weather changes, time changes, extended computer usage, birthday greetings, etc.**</a>

6. Complete <a href="#en-mod-editor">**Mod creation toolchain**</a>, form-based editor — no coding required

7. Supports <a href="#en-mod-switching">**switching between multiple Mods and multi-version management for a single Mod**</a>

8. AI Tools: <a href="#en-ai-tools">**AI Tools for companionship when you're busy**</a>

9. Utility features: <a href="#en-utility-features">**Memo and Timed Reminders**</a>

10. Multi-language: <a href="#en-multi-language">**简体中文/English/日本語**</a>
...
We provide a complete <a href="#en-auxiliary-tools">**toolchain**</a> to process differential frames/GIF/video into spritesheets for in-app animation. The other three formats use their original files directly, and the editor supports parsing these files
...
> [!TIP]<br>
> If you have more formats you'd like us to support, feel free to let us know<br>
> Contact us: QQ Group: <a href="docs/imgs/QQ群.jpg" target="_blank" rel="noopener noreferrer">578258773</a>   Bilibili: <a href="https://b23.tv/ZKVKHH0" target="_blank" rel="noopener noreferrer">_Cafel_</a>

<br>

<a id="en-package-encryption"></a>
...
For WebGL-based programs, oversized texture resources can consume large amounts of memory, which has always been a difficult problem to solve

<img src="docs/imgs/profile1.png"/>

<br>

To minimize memory usage, we support texture downsampling during WebGL rendering<br>
...
Additionally, we support customizing the maximum frame rate through configuration<br>
Excessively high frame rates will increase GPU usage; appropriately lowering the frame rate can reduce GPU load<br>
After installation, you can modify the **render_tuning.json** file in the **Config** folder within the installation directory to customize optimization behavior

<br>

<a id="en-dialogue-event-chains"></a>

### 4. Dialogue Event Chains
...
Our application supports a comprehensive form-based Mod Editor. You can complete most configurations without writing any code

<img src="docs/imgs/en/editor1.png"/>
<img src="docs/imgs/en/editor2.png"/>
<img src="docs/imgs/en/editor3.png"/>
<img src="docs/imgs/en/editor4.png"/>
<img src="docs/imgs/en/state1.png"/>

<br>

> [!TIP]<br>
> Official tutorial videos will be released in the future, stay tuned<br>
> If you have any questions during use, feel free to contact us for help
...
<a id="en-mod-switching"></a>

### 7. Mod Switching & Multi-Version Management
...
<img src="docs/imgs/en/mod1.png" width="540"/>
<img src="docs/imgs/en/mod2.png" width="540"/>
...
This application provides customizable AI tools that can detect the software or game you are currently using, and provide feedback for supported software or games

The main effect depends on your prompts and the AI's intelligence

<br>

<a href="https://www.bilibili.com/video/BV1idwczDE41" target="_blank" rel="noopener noreferrer"><b>Demo Video</b></a>

<a href="https://www.bilibili.com/video/BV1idwczDE41" target="_blank" rel="noopener noreferrer"><img src="docs/imgs/微信图片_20260311162306_1619_13.png" width="540"/></a>

<br>

<a id="en-utility-features"></a>

### 9. Utility Features

- **Memo** — Auto-popup on screen unlock, also viewable manually
  - <img src="docs/imgs/en/other1.png" width="540"/>
- **Timed Reminders** — Set popup reminders for specific times
  - <img src="docs/imgs/en/other2.png" width="540"/>

<br>

<a id="en-multi-language"></a>

### 10. Multi-language

This project supports i18n real-time multi-language switching. You can adjust it in **Right-click Menu - Settings - Interface Language**
...
The lite version only includes the tutorial Mod; the standard version includes some default Mods
...
After installation, users can modify config files in the Config folder within the installation directory to customize behavior:
...
| `config/render_tuning.json`              | Optimization settings, frame rate limiting |
...
<a id="en-auxiliary-tools"></a>

### 3. Auxiliary Tools (`other-tool/`)
...
Launch by double-clicking the corresponding .bat file
...
> If you find any code issues in the project, please let us know — we are deeply grateful<br>
> If you are uncomfortable with AI-related content, please simply ignore this project, and we apologize
...
Or run the one-click development script (requires admin privileges):
...
Run the one-click build script (requires admin privileges):
...
<a href="https://pan.baidu.com/s/5674aiDV7d4JWbMEySD28Ew" target="_blank" rel="noopener noreferrer">百度網盤</a>&nbsp;&nbsp;&nbsp;
...
どんなアニメーション素材でもすぐに始められます：
<a href="docs/tutorial/NewMod.md" target="_blank" rel="noopener noreferrer">素早く デスクトップペットを移行/作成</a>
...
表示されているModはデモ目的のみです。ソースについては対応するリンクをご参照ください

コンテンツにライセンス/著作権の問題がある場合は、交換または削除いたしますのでご連絡ください
...
<a href="" target="_blank" rel="noopener noreferrer"><b>シーケンスフレーム 物体</b></a>
...
3. メモリ使用量の最適化：<a href="#jp-メモリ最適化">**テクスチャダウンサンプリング、フレームレート制限 等**</a>

4. 複雑な<a href="#jp-対話イベントチェーン">**対話イベントチェーン**</a>と音声設定に対応

5. 多様なイベントに対応：<a href="#jp-システムイベント">**キーボード/マウス、音楽再生、PC解除、仕事アプリ起動、ドラッグ、全画面アプリ起動、天気変化、時間変化、長時間PC使用、誕生日挨拶 など**</a>

6. 完全な<a href="#jp-Modエディター">**Mod制作ツールチェーン**</a>、フォーム式エディターでコード不要

7. <a href="#jp-Mod切り替え">**複数Modの切り替えと単一Modのマルチバージョン管理**</a>に対応

8. AIツール：<a href="#jp-AIツール">**忙しい時の付き添いを提供するAIツール**</a>

9. 便利機能：<a href="#jp-便利機能">**メモとタイマーリマインダー**</a>

10. 多言語：<a href="#jp-多言語">**简体中文/English/日本語**</a>
...
差分画像/GIF/動画をスプライトシートに処理するための完全な<a href="#jp-補助ツールセット">**ツールチェーン**</a>を提供しています。他の3つの形式は元のファイルをそのまま使用し、エディター内でファイルの解析をサポートしています
...
> [!TIP]<br>
> さらに対応してほしい形式があれば、ぜひフィードバックをお願いします<br>
> お問い合わせ：QQ群：<a href="docs/imgs/QQ群.jpg" target="_blank" rel="noopener noreferrer">578258773</a>   Bilibili: <a href="https://b23.tv/ZKVKHH0" target="_blank" rel="noopener noreferrer">_Cafel_</a>
...
WebGLベースのプログラムでは、テクスチャリソースのサイズが大きすぎると大量のメモリを消費します。これは常に解決が困難な問題でした

<img src="docs/imgs/profile1.png"/>

<br>

メモリ使用量を最小限に抑えるため、WebGLレンダリング時のテクスチャダウンサンプリングをサポートしています<br>
...
また、設定ファイルによる最大フレームレートのカスタマイズもサポートしています<br>
フレームレートが高すぎるとGPU使用率が増加します。フレームレートを適切に下げることでGPU負荷を軽減できます<br>
インストール後、インストールディレクトリ内の **Config** フォルダにある **render_tuning.json** ファイルを変更して最適化動作をカスタマイズできます

<br>

<a id="jp-対話イベントチェーン"></a>
...
- **テキスト＆音声** — 複雑なテキストと音声の設定をサポート、多言語対応
  - <img src="docs/imgs/jp/state1.png"/>

- **対話イベントチェーン** — 直接リンク、対話分岐、ランダムトリガーなどのテキストイベントチェーンをサポート
  - <img src="docs/imgs/jp/state2.png"/>

- **条件トリガー** — 日付/時刻/カウンター/気温/天気/稼働時間による条件付きトリガー
  - <img src="docs/imgs/jp/state3.png"/>
...
本アプリケーションは充実したフォーム式Modエディターをサポートしています。コードを一切書かずにほとんどの設定を完了できます

<img src="docs/imgs/jp/editor1.png"/>
<img src="docs/imgs/jp/editor2.png"/>
<img src="docs/imgs/jp/editor3.png"/>
<img src="docs/imgs/jp/editor4.png"/>
<img src="docs/imgs/jp/state1.png"/>

<br>

> [!TIP]<br>
> 今後、公式チュートリアル動画シリーズを公開予定です。お楽しみに<br>
...
### 7. Mod切り替えとマルチバージョン管理

アプリにはMod切り替えとマルチバージョン管理機能が内蔵されています。複数のMod間で簡単に切り替えができ、同じModの異なるバージョンをインポートすることも可能です

<img src="docs/imgs/jp/mod1.png" width="540"/>
<img src="docs/imgs/jp/mod2.png" width="540"/>
...
本アプリケーションはカスタマイズ可能なAIツールを提供しており、現在使用中のソフトウェアやゲームを検出し、対応するソフトウェアやゲームに対してフィードバックを提供します

主な効果はプロンプトとAIの知能に依存します

<br>

<a href="https://www.bilibili.com/video/BV1idwczDE41" target="_blank" rel="noopener noreferrer"><b>デモ動画</b></a>
...
- **メモ** — 画面ロック解除時に自動ポップアップ、手動表示も可能
  - <img src="docs/imgs/jp/other1.png" width="540"/>
- **タイマーリマインダー** — 指定時刻のポップアップリマインダー設定
  - <img src="docs/imgs/jp/other2.png" width="540"/>
...
本プロジェクトはi18nリアルタイム多言語切り替えに対応しています。**右クリックメニュー - 設定 - インターフェース言語** で調整できます
...
軽量版にはチュートリアルModのみ含まれ、通常版にはいくつかのデフォルトModが含まれます
...
インストール後、インストールディレクトリ内のConfigフォルダにある設定ファイルを変更して動作をカスタマイズできます：
...
| `config/render_tuning.json`             | 最適化関連設定、フレームレート制限 |
...
> プロジェクト内にコードの問題を発見された場合は、フィードバックをいただけると大変ありがたく存じます<br>
> AI関連のコンテンツがお気に召さない場合は、本プロジェクトを無視してください。お詫び申し上げます
...
またはワンクリック開発スクリプトをダブルクリックで実行（管理者権限が必要）：
...
ワンクリックビルドスクリプトをダブルクリックで実行（管理者権限が必要）：
